...
class CocktailsController < ApplicationController
  ...
  def cocktails_sorter
    ...
    # Filtering by the options selected by the user
      ...
      cocktails_sorted = params[:ingredients].present? ? filter_by_ingredients : Cocktail.all     # Filter by Ingredients
    ...
    # does not select any, the sorting will also be done by ranking
      ...
      return Cocktail.all.sort_by { |cocktail| - cocktail.rating_points }
    end
  end
